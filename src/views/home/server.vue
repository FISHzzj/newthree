<template>
    <div class="server">
        ...
        <!-- <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=1169254794&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:1169254794:52" alt="1111" title="1111"/></a> -->
        <div class="submit" @click="sumbit">QQ客服</div>
    </div>
</template>
<script>
export default {
